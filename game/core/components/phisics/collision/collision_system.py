...
class CollisionSystem(BaseSystem):
    visible_collision_object_list: List[CollisionMixin] = []

    @classmethod
    def update_visible_objects(cls, visible_objects) -> None:
    ...
    @classmethod
    def check_collision(cls, rect: pygame.Rect, ignore_list=None) -> CollisionMixin | None:
